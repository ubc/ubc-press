<?php
namespace UBC\Press\Plugins\SiteBuilder\Widgets\AddDiscussionForum;
/*
Widget Name: Include Discussion Forum
Description: Add a discussion forum to a section
Author: Richard Tape
...
class AddDiscussionForumWidget extends \SiteOrigin_Widget {
			...
			array(
				'discussion_forum_post_id' => array(
					...
					'state_emitter' => array(
						...
						'args' => array(
							array( 'fieldtype' => 'select', 'selector' => 'discussion_forum_post_id' ),
				...
				'text' => array(
					...
					'label' => 'Title',
					'state_handler' => array(
				        'discussion_forum_post_id[none_found]' => array( 'hide' ),
				        '_else[discussion_forum_post_id]' => array( 'hide' ),
				    ),
				),
			),
	...
	function get_template_name( $instance ) {
		return 'discussion-forum-widget';
	}
...
siteorigin_widget_register( 'ubc-discussion-forum', __FILE__, '\UBC\Press\Plugins\SiteBuilder\Widgets\AddDiscussionForum\AddDiscussionForumWidget' );
