<?php
namespace UBC\Press\Plugins\SiteBuilder\Widgets\AddDiscussionTopic;
/*
Widget Name: Include Discussion Topic
Description: Add a discussion topic to a section
Author: Richard Tape
...
class AddDiscussionTopicWidget extends \SiteOrigin_Widget {
			...
			array(
				'discussion_topic_post_id' => array(
					...
					'state_emitter' => array(
						...
						'args' => array(
							array( 'fieldtype' => 'select', 'selector' => 'discussion_topic_post_id' ),
				...
				'text' => array(
					...
					'label' => 'Title',
					'state_handler' => array(
						'discussion_topic_post_id[none_found]' => array( 'hide' ),
						'_else[discussion_topic_post_id]' => array( 'hide' ),
					),
				),
			),
	...
	function get_template_name( $instance ) {
		return 'discussion-topic-widget';
	}
...
siteorigin_widget_register( 'ubc-discussion-topic', __FILE__, '\UBC\Press\Plugins\SiteBuilder\Widgets\AddDiscussionTopic\AddDiscussionTopicWidget' );
