<ul class="tabs text-center row-smll-collapse align-items-center" id="course-dashbord-tabs" data-tabs>
		...
		<li class="tabs-title"><a href="#panel3v"><svg class="ui-icon heart"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#bookmark" aria-hidden="true"></use></svg> <span class="hide-for-small-only">Bookmarks</span></a></li>
		...
		<li class="tabs-title"><a href="#panel5v"><svg class="ui-icon chat"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#chat" aria-hidden="true"> <span class="hide-for-small-only">Discussions</span></a></li>
</ul>
