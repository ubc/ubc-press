...
namespace UBC\Press\Widgets\InstructorWidget;
...
class Setup extends \WP_Widget {
	 ...
	 * @var      string
	 */
	protected $widget_slug = 'instructor-information';
	protected $widget_name = 'Instructor Information';
	protected $widget_description = 'Instructor information such as contact and office hours.';
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['office_hours'] = array();

		if ( isset( $new_instance['office_hours'] ) ) {
			foreach ( $new_instance['office_hours'] as $value ) {

			    if ( '' !== trim( $value ) ) {

			        $instance['office_hours'][] = $value;
