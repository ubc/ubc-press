...
namespace UBC\Press\Widgets\SectionComponentWidget;
...
class Setup extends \WP_Widget {
	 ...
	 * @var      string
	 */
	protected $widget_slug = 'widget-section-component';
	protected $widget_name = 'Course components';
	protected $widget_description = 'Links to sections that contain as specific component type. Quizze, assignments and so on.';
